...
//#region resources/js/Pages/Admin/Roles/Edit.vue
var _sfc_main = {
	__name: "Edit",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push(ssrRenderComponent(unref(Head), { title: unref(t)("roles.editRole") }, null, _parent));
			_push(ssrRenderComponent(_sfc_main$1, {
				"nav-items": unref(adminNavItems),
				"page-title": unref(t)("roles.editRole")
			}, {
